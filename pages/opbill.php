...
<div class="card">
                <div class="card-body">
                  <h5 class="card-title">Failed Bill Payments</h5>

                  <?php

if(!isset($_GET["trans_id"])){
    pagination_history_before("sbill","null");
}
elseif(empty($_GET["trans_id"])){
  pagination_history_before("sbill","null");
    ...
    if(is_numeric($_GET["trans_id"])){
        $id = $_GET["trans_id"];
        pagination_history_before("sbill","null","AND id = '$id'");
    }
    else{
        $id = $_GET["trans_id"];
        pagination_history_before("sbill","null","AND request_id = '$id'");
    }
}
